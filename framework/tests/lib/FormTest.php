...
class FormTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testNoTokenGenerated()
    {
        ...
        $render = $this->baseForm->setOutput()->getOutput();
